...
>(function SidebarProvider(
  ...
  // Read cookie value or fall back to defaultOpen
  ...
  const setSidebarState = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Set the cookie with the updated state
  ...
  const toggleSidebar = React.useCallback(() => {
    return isMobile
      ...
      : setSidebarState((open) => !open)
  }, [isMobile, setSidebarState, setOpenMobile])
  ...
  const contextValue = React.useMemo<SidebarContext>(
    ...
    [state, open, setSidebarState, isMobile, openMobile, setOpenMobile, toggleSidebar]
  )
