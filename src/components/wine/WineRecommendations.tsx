    ...
    <Card className="backdrop-blur-sm bg-card/80">
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Select preferred wine for each dish
        </p>
      </CardHeader>
      <CardContent className="space-y-8">
        ...
        >
          <div>
            <h3 className="text-lg text-primary font-medium">{rec.original_dish}</h3>
        ...
        <div className="flex justify-between items-center gap-4 pt-2">
          ...
          <Button
            variant="outline"
            onClick={() => setCurrent((c) => Math.min(recommendations.length - 1, c + 1))}
        ...
        {addedWines.size > 0 && (
          <div className="flex justify-center pt-4">
            <Button asChild variant="default" className="w-full py-6 text-base">
              <Link href="/dashboard/product">Back to Dashboard</Link>
            </Button>
          </div>
        )}
      </CardContent>
